...
const Jewelry = () => {
  return (
    <div className="px-1  text-gray-700">
      ...
      {/* bottom */}
      <div className="flex flex-col md:flex-row justify-between py-4 mt-2 gap-10">
        {/* left */}
        ...
        {/* right */}
        <div className="flex basis-1/2  flex-col lg:flex-row ">
          <div className=" w-full px-4 lg:px-0 lg:w-80">
            <Image
              width={1000}
              height={1000}
              src={
                "https://full-stack-ecommerce-clothing-web.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ffeature.1118a2f3.png&w=640&q=75"
              }
          ...
          <div className="space-y-6 md:space-y-4 p-6">
            <p
              ...
              className="h-[90%] lg:max-w-[15rem] text-lg"
            >
            ...
            <button className="text-white bg-gray-700 rounded-md py-2 px-6">
              See All Products
            </button>
          </div>
        </div>
